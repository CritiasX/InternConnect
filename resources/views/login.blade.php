...
<body class="min-h-screen bg-gray-100">
    ...
    <div class="mt-20 flex items-center justify-center text-center p-6">
            <form action="{{route('login')}}" method="POST">
                ...
                <input type="text" placeholder="Password" class="text-center p-2 border rounded mb-4" required>
                <input type="password" placeholder="Password" class="text-center p-2 border rounded" required>
